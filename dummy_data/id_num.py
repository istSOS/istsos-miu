...
def id_sequence():
    ...
    cur.execute('SELECT COUNT(*) FROM sensorthings."Location";')
    ...
    cur.execute('SELECT COUNT(*) FROM sensorthings."Thing";')
    ...
    cur.execute('SELECT COUNT(*) FROM sensorthings."HistoricalLocation";')
    ...
    cur.execute('SELECT COUNT(*) FROM sensorthings."ObservedProperty";')
    ...
    cur.execute('SELECT COUNT(*) FROM sensorthings."Sensor";')
    ...
    if sensor_id!=None:
        ...
        sensor_id=0
    # print(sensor_id)
    cur.execute('SELECT COUNT(*) FROM sensorthings."Datastream";')
    ...
    cur.execute('SELECT COUNT(*) FROM sensorthings."FeaturesOfInterest";')
